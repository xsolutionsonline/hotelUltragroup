...
const routes: Routes = [
  { path: 'dashboard', loadChildren: () => import('./shared/components/shared.module').then(m => m.SharedModule) },
  ...
  { path: 'list-rooms-reservation/:id', loadChildren: () => import('./reservation/reservation.module').then(m => m.ReservationModule)  },
  { path: 'list-hotels-reservation', loadChildren: () => import('./reservation/reservation.module').then(m => m.ReservationModule)},
